...
data = timeseries(data_arr(:,2:end),(data_arr(:,1)-data_arr(1,1))/1000);

%%
out = sim('simulator_EKF.slx');
...
animate(t1, out.q_chair.Data, out.q_observer.Data, out.q_ref.Data, out.u.Data)